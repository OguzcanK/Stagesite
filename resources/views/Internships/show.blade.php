                ...
                <div class="panel panel-default">
                    ...
                    @if(Auth::check())
                        @if(Auth::user()->getRole() == 'practical trainer' OR Auth::user()->getRole() == 'admin')
                            @if(Auth::user()->contact_id == $contactz[1])
                                        <?php $check = TRUE ?>
                            @endif
                        @endif
                    @endif
                    ...
                    @if(isset($check))
                        <div class="panel-body">
                            ...
                            <p>
                                <a href="{{ route('internship.edit', $contactz[0]) }}" class="btn btn-info">Edit</a>
                            </p>
                        </div>
                    @endif
                    <div class="well">
                            ...
                            @foreach ($array as $review)
                                ...
                                <div class="well">
                                    ...
                                    @if($review->status_id == 1)
                                        {{ $contact->firstname }} {{ $contact->insertion }} {{ $contact->surename }}<br>
                                        Mark: {{ $review->mark }}<br>
                                        {{ $review->review }}<br>
                                    @if(Auth::check())
                                        @if(Auth::user()->getRole() == 'student' OR Auth::user()->getRole() == 'admin' OR Auth::user()->getRole() == 'teacher')
